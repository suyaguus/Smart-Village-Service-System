            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <section className="w-full lg:w-2/3" aria-label="Konfigurasi Form Layout">
                    <Card className="flex flex-col h-full min-h-[500px]">
                        <header className="p-6 border-b border-[#D6E6F2] flex justify-between items-start">
                            <div>
                                <span className="px-2 py-1 bg-[#D6E6F2] text-[#769FCD] text-xs font-bold rounded-md mb-2 inline-block">{activeSurat.kode_surat}</span>
                                <h2 className="text-xl font-bold text-slate-800">{activeSurat.nama_surat}</h2>
                                <p className="text-sm text-slate-600 mt-1">{activeSurat.deskripsi}</p>
                            </div>
                        </header>

                        <div className="p-6 bg-[#F7FBFC] flex-1">
